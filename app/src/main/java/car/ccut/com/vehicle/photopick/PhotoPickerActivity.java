...
import car.ccut.com.vehicle.photopick.adapters.FloderAdapter;
import car.ccut.com.vehicle.photopick.adapters.PhotoAdapter;
import car.ccut.com.vehicle.photopick.beans.Photo;
import car.ccut.com.vehicle.photopick.beans.PhotoFloder;
import car.ccut.com.vehicle.photopick.utils.LogUtils;
import car.ccut.com.vehicle.photopick.utils.OtherUtils;
import car.ccut.com.vehicle.photopick.utils.PhotoUtils;
...
public class PhotoPickerActivity extends Activity implements PhotoAdapter.PhotoClickCallBack {
    ...
    public void onPhotoClick() {
        ...
        if(list != null && list.size()>0) {
            ...
            mCommitBtn.setText(R.string.sure);
        }
    }
    ...
    private void toggleFloderList(final List<PhotoFloder> floders) {
        ...
        if(!mIsFloderViewInit) {
            ...
            final FloderAdapter adapter = new FloderAdapter(getApplicationContext(), floders);
