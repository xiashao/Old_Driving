...
public class BaseAdapterHelper {
    ...
    private ImageLoadingListener animateFirstListener = new Utils.AnimateFirstDisplayListener();
     ...
     * It uses universal-image-loader library to download the image asynchronously and put the result into the ImageView.<br/>
     * @param viewId   The view id.
    ...
    public BaseAdapterHelper setImageUrl(int viewId, String imageUrl) {
        ...
        imageLoader.displayImage(imageUrl, view, MyApplication.getOptions(), animateFirstListener);
        return this;
    }

    public BaseAdapterHelper setTextWithDel(int viewId, String value) {
        TextView view = getView(viewId);
        view.setText(value);
        Utils.textViewDelStyle(view);
        return this;
    }

    public BaseAdapterHelper setButtonEnable(int viewId, boolean enable) {
