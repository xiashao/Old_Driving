...
import car.ccut.com.vehicle.adapter.WeizhangResponseAdapter;
...
public class WeizhangResult extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent it = getIntent();
        car.setChejia_no(it.getStringExtra("classno"));
        car.setChepai_no(it.getStringExtra("hphm"));
        car.setEngine_no(it.getStringExtra("engineno"));
        car.setCity_id(it.getIntExtra("city_id", car.getCity_id()));
        step4(car);
