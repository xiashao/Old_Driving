...
public class CircleMenuLayout extends ViewGroup
{
	 ...
	 * @param resIds
	 */
	public void setMenuItemIconsAndTexts(int[] resIds, String[] texts,int[] colors)
	{
		mItemImgs = resIds;
		mItemTexts = texts;
		mItemTextsColors = colors;
	...
	private void addMenuItems()
	{
		...
		for (int i = 0; i < mMenuItemCount; i++)
		{
			...
			if (tv != null)
			{
				...
				tv.setTextColor(getResources().getColor(mItemTextsColors[i]));
			}
